...
- [Staging walkthrough](ship-walkthrough.md) — **opt-in**: `/ship` walks the change's own scenarios against the deployed preview in a real browser; installing Playwright is the entire opt-in.
