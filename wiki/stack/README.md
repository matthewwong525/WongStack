...
- [Staging walkthrough](../development/staging-walkthrough.md) — `/walk` walks the change's own scenarios against the deployed preview in a real browser and grades them against what those scenarios promised. It is not stack-specific and lives with the development docs; this entry points at it because the pack's pipeline is what publishes the preview it walks.
