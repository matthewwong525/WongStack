...
> 5. **`.claude/skills/`** — existing skills, especially collisions: `explore`, `plan`, `apply`, `save`, `continue`, `ship`, `document`, `improve`.
...
{ "version": "$LATEST", "installedAt": "<existing, or today>", "updatedAt": "$(date +%F)",
  "components": { "skills": ["explore","plan","apply","save","continue","ship","document","improve"], "claudeMd": true, "docs": true, "openspec": true } }
EOF
```
