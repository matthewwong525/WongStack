...
**Reason**: There is no visual author; the planning agent writes text visuals in the proposal.
**Migration**: See `ux-wireframes`, "The planning agent draws the visuals in one pass".
