...
- 2026-09-21: Merged current `origin/main` after PR #90 landed the independent 16.1.1 payload-CI fix. Preserved that workflow, archive, spec, note, and changelog entry; 16.2.0 remains the next additive minor release.
