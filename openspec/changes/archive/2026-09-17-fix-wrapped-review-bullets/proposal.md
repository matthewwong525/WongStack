...
- **2026-09-17** — `/ship` confirmed all 10 tasks complete and the one delta spec synced into `openspec/specs/ux-wireframes/spec.md`, then archived this change. `/save` checkpoints the archive move for CI before the squash merge.
