...
#### Scenario: A team digest

- **WHEN** a session starts in a team repo, and a teammate wrote a `user` fact
- **THEN** the digest does not show that fact, and it shows the teammate's open threads
