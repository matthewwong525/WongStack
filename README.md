...
That's the whole install. Claude clones WongStack, researches your repo, merges your `CLAUDE.md`, installs the skills (`/save`, `/preview`, `/continue`, `/ship`, `/document`), and seeds the `docs/` wiki — **asking before it changes anything**. Paste it again any time to update.
