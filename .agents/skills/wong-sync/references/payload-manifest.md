...
- The whole `wiki/stack/` section (hub + `getting-started.md`, `provisioning.md`, `core-stack.md`, `d1-pipeline.md`, `cloudflare-access.md`, `cloudflare-credentials.md`, `staging-walkthrough.md`) — the human walkthrough, the provisioning runbook, the pipeline and Cloudflare-setup docs, and the opt-in staging walkthrough.
